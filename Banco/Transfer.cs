        ...
        private void txtToAccount_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (dr.Read())
            {
                if(txtToAccount.Text == txtfrmAccount.Text)
                {
                    ...
                    txttransferPrompt.Text = "No se puede transferir a su cuenta, use el depósito en su lugar!";
                ...
                else
                {
                    ...
                    if (dr2.Read())
                    {
                        txttransferPrompt.Text = $"Transfiriendo ${txtAmount.Text} to {dr2[0].ToString()} {dr2[1].ToString()}";
                        txttransferPrompt.Visible = true;
            ...
            else
            {
                txttransferPrompt.ForeColor = Color.Red;
                txttransferPrompt.Visible = true;
                txttransferPrompt.Text = "Usuario no encontrado!";
        ...
        private void btnconfirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    transaction.Commit();
                    MessageBox.Show("Transacsion exitosa!!!");
